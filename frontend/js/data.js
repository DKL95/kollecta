...
const KOLLECTA_DATA = {
  ...
  products: [
    { id: "p1", title: "Photocard Jimin — 'Face' PC Album", group: "BTS", type: "Photocard", price: 280, mode: "Venta", emoji: "🃏", tag: "Oficial", seller: "mina.cards", sellerInit: "MC", img: "assets/img/products/p1.jpg" },
    { id: "p2", title: "Lightstick Ver.3 'Bomb' + funda", group: "BTS", type: "Lightstick", price: 950, mode: "Venta", emoji: "🔮", tag: "Como nuevo", seller: "army_mty", sellerInit: "AM", img: "assets/img/products/p2.jpg" },
    { id: "p3", title: "Photocard Set Jennie — 'Born Pink'", group: "BLACKPINK", type: "Photocard", price: 0, mode: "Intercambio", emoji: "🖤", tag: "Busco: Rosé", seller: "blinknena", sellerInit: "BN", img: "assets/img/products/p3.jpg" },
    { id: "p4", title: "Álbum 'Born Pink' (sellado)", group: "BLACKPINK", type: "Álbum", price: 620, mode: "Venta", emoji: "💿", tag: "Sellado", seller: "pink.vault", sellerInit: "PV", img: "assets/img/products/p4.jpg" },
    { id: "p5", title: "Hoodie Oficial 'Ready to Be' Tour", group: "TWICE", type: "Ropa", price: 1150, mode: "Venta", emoji: "🧥", tag: "Talla M", seller: "onceforever", sellerInit: "OF", img: "assets/img/products/p5.jpg" },
    { id: "p6", title: "Photocard Felix — 'Rock-Star'", group: "Stray Kids", type: "Photocard", price: 190, mode: "Venta", emoji: "🃏", tag: "Oficial", seller: "stay_norte", sellerInit: "SN", img: "assets/img/products/p6.jpg" },
    { id: "p7", title: "Keyring acrílico set 8pcs", group: "Stray Kids", type: "Accesorio", price: 340, mode: "Venta", emoji: "🔑", tag: "Fanmade", seller: "chan.shop", sellerInit: "CS", img: "assets/img/products/p7.jpg" },
    { id: "p8", title: "Poster oficial 'God of Music'", group: "SEVENTEEN", type: "Poster", price: 260, mode: "Venta", emoji: "🖼️", tag: "Edición limitada", seller: "caratmx", sellerInit: "CX", img: "assets/img/products/p8.jpg" },
    { id: "p9", title: "Photocard Hoshi — busco Wonwoo", group: "SEVENTEEN", type: "Photocard", price: 0, mode: "Intercambio", emoji: "🃏", tag: "Busco: Wonwoo", seller: "svt.trades", sellerInit: "ST", img: "assets/img/products/p9.jpg" },
    { id: "p10", title: "Álbum 'Get Up' + photobook", group: "NewJeans", type: "Álbum", price: 540, mode: "Venta", emoji: "💿", tag: "Con extras", seller: "bunny.dept", sellerInit: "BD", img: "assets/img/products/p10.jpg" },
    { id: "p11", title: "Lightstick oficial aespa", group: "aespa", type: "Lightstick", price: 890, mode: "Venta", emoji: "🔮", tag: "Nuevo", seller: "myworld_mx", sellerInit: "MW", img: "assets/img/products/p11.jpg" },
    { id: "p12", title: "Photocard set completo — 'Golden Hour'", group: "ATEEZ", type: "Photocard", price: 420, mode: "Venta", emoji: "🃏", tag: "Set completo (8)", seller: "atiny.station", sellerInit: "AS", img: "assets/img/products/p12.jpg" },
  ],
